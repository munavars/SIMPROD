...
public class TiredexAppException extends Exception {
     ...
     */
    public TiredexAppException () {
        super();
    }

    public TiredexAppException (String errorMessage) {
        super(errorMessage);
     ...
     *            java.util.Map
     */
    public TiredexAppException (String anErrorId,
     ...
     *            java.util.Map
     */
    public TiredexAppException (String anErrorId, String anErrorMessage) {
        this.errorId = anErrorId;
        this.message = anErrorMessage;
    }
