var EditableTable = function () {
    ...
    return {
        ...
        init: function () {
            ...
            var oTable = $('#editable-sample,#editable-sample2,#editable-sample3,#pending-approvals,#customers-overview').dataTable({
                "aLengthMenu": [
                    [5, 10, 20, -1],
            ...
            $('#editable-sample a.delete,#editable-sample2 a.delete,#editable-sample3 a.delete,#pending-approvals a.delete,#customers-overview a.delete').live('click', function (e) {
                e.preventDefault();
            ...
            $('#editable-sample a.cancel,#editable-sample2 a.cancel,#editable-sample3 a.cancel,#pending-approvals a.cancel,#customers-overview a.cancel').live('click', function (e) {
                e.preventDefault();
            ...
            $('#editable-sample a.edit,#editable-sample2 a.edit,#editable-sample3 a.edit,#pending-approvals a.edit,#customers-overview a.edit').live('click', function (e) {
                e.preventDefault();
