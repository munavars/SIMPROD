...
public class QueryConstant {
	...
	public static final String NEW_CUSTOMER_QUERY = "SELECT * FROM CUSTOMER ";
	
	//public static final String NEW_CUSTOMER_ACCOUNT_MANAGER_CHECK = " AND ACCOUNT_MANAGER in (:userIdList)";
	
	public static final String NEW_CUSTOMER_ACCOUNT_MANAGER_CHECK = " WHERE ACCOUNT_MANAGER in (:userIdList)";
