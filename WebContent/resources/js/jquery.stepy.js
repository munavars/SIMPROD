 ...
 *		</fieldset>
 *
 *		<input type="submit" class="finish" value="Confirm"/>
 *	</form>
 *
 */
...
;(function($) {
	...
	var methods = {
		init: function(options) {
        	...
        	$('<a/>', { id: id + '-back-' + index, href: 'javascript:void(0);', 'class': 'button-back btn btn-info btn-lg', html: opt.backLabel }).click(function() {
        	...
        	$('<a/>', { id: id + '-next-' + index, href: 'javascript:void(0);', 'class': 'button-next  btn btn-info btn-lg', html: opt.nextLabel }).click(function() {
